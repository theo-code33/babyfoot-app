  ...
  return (
    <Box sx={style} className="user-game-connect_container">
      <Box
        ...
        className="user-game-connect_form"
      >
        <TextField
          type="number"
          name="email"
        ...
        />
        {isPlaying && (
          <p className="user-game-connect_error">La partie est déjà en cours</p>
        )}
        {error && <p className="user-game-connect_error">Code invalide</p>}
        <Button
          type="submit"
          variant="contained"
          className="user-game-connect_button"
        >
          Rejoindre
        </Button>
        <Typography
          variant="h5"
          className="user-game-connect_text"
          sx={{ textAlign: "center", mt: "45px" }}
        >
          Vous avez un Qr code ? Scannez le pour rejoindre la partie
        </Typography>
        <Button
          variant="contained"
          className="user-game-connect_button"
          onClick={() => navigate("/read-qr-code")}
        >
          Scanner le Qr code
        </Button>
      </Box>
